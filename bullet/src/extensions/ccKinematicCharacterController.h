...
#ifndef CC_KINEMATIC_CHARACTER_CONTROLLER_H
#define CC_KINEMATIC_CHARACTER_CONTROLLER_H
...
ATTRIBUTE_ALIGNED16(class) ccKinematicCharacterController : public btCharacterControllerInterface
{
protected:
...
public:
	...
	ccKinematicCharacterController (btPairCachingGhostObject* ghostObject,btConvexShape* convexShape,btScalar stepHeight, int upAxis = 1);
